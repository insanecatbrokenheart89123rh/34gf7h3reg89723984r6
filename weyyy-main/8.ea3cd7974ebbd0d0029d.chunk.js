  ...
  [8],
  {
    196: function (e, t, o) {
      ...
      t.default = {
        ...
        "Chat.Menu.Hint":
          "To **edit** or **reply**, close this menu.\nThen tap next to a message.",
        ...
        "ChatList.Main.EmptyPlaceholder.SubtitleNoContacts":
          "Use Telegram app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts",
        ...
        "Message.Unsupported.Desktop":
          "__This message is currently not supported on Telegram Web. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__",
        "Message.Unsupported.Mobile":
          "__This message is currently not supported on Telegram Web. Try [telegram.org/dl](https://telegram.org/dl/)__",
        ...
        "Popup.Unpin.HideDescription":
          "Do you want to hide the pinned message bar? It wil stay hidden until a new message is pinned.",
        ...
        FromYou: "You",
        Add: "Add",
        Chats: { one_value: "%1$d chat", other_value: "%1$d chats" },
        Channels: { one_value: "%1$d channel", other_value: "%1$d channels" },
        Comments: { one_value: "%1$d Comment", other_value: "%1$d Comments" },
        Groups: { one_value: "%1$d group", other_value: "%1$d groups" },
        Users: { one_value: "%1$d user", other_value: "%1$d users" },
        Members: { one_value: "%1$d member", other_value: "%1$d members" },
        messages: { one_value: "%1$d message", other_value: "%1$d messages" },
        ...
        Stickers: { one_value: "%1$d sticker", other_value: "%1$d stickers" },
        ...
        Seconds: { one_value: "%1$d second", other_value: "%1$d seconds" },
        Minutes: { one_value: "%1$d minute", other_value: "%1$d minutes" },
        Hours: { one_value: "%1$d hour", other_value: "%1$d hours" },
        Days: { one_value: "%1$d day", other_value: "%1$d days" },
        Weeks: { one_value: "%1$d week", other_value: "%1$d weeks" },
        ...
        InviteToChannelError:
          "Sorry, you can't add this user to channels because of user's privacy settings.",
        ...
        LogOut: "Log out",
        OnlineCount: { one_value: "%1$d online", other_value: "%1$d online" },
        ...
        MessageSeen: { one_value: "Seen", other_value: "%1$d Seen" },
        ...
        "Call.PrivacyErrorMessage":
          "Sorry, you cannot call %@ because of their privacy settings.",
        ...
        "Chat.Context.ReactedFast": { other_value: "%d Reacted" },
        ...
        "PollResults.LoadMore": { other_value: "Show More (%d)" },
...
//# sourceMappingURL=8.ea3cd7974ebbd0d0029d.chunk.js.map
